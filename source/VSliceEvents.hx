package;
// I took this from P-Slice
// https://github.com/Psych-Slice/P-Slice/blob/master/source/mikolka/stages/scripts/VSliceEvents.hx
...
class VSliceEvents extends BaseStage {
    ...
    override function eventCalled(eventName:String, value1:String, value2:String, flValue1:Null<Float>, flValue2:Null<Float>, strumTime:Float) {
        switch (eventName){
            ...
            case 'Set Camera Bopping': //Psych Extended event notes
            ...
            case 'Target Camera': //Psych Extended event notes val1: char val2: x,y,dur,ease
                ...
                if(CustomArrayTools.findIndex(floaties,s -> Math.isNaN(s)) != -1) {
