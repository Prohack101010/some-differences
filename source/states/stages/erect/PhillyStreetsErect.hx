...
class PhillyStreetsErect extends BaseStage
{
	...
	override function create()
	{
		...
		add(mist4);
		//? gradient
		var gray1:BGSprite = new BGSprite('phillyStreets/greyGradient', 88, 317, 1, 1);
		gray1.alpha = 0.3;
		gray1.blend = ADD;
		add(gray1);

		var gray2:BGSprite = new BGSprite('phillyStreets/greyGradient', 88, 317, 1, 1);
		gray2.alpha = 0.8;
...
function makeMist(image:String,scrollFac:Float,alpha:Float,velX:Float) {
	var mist = new FlxBackdrop(Paths.image('phillyStreets/$image'), X);
